...
type NonSortableHealthcareProfessionalFilter = BaseHealthcareProfessionalFilterBuilder<HealthcareProfessionalFilter> &
  FilterBuilder<HealthcareProfessional>

class HealthcareProfessionalFilterSortStepDecorator implements BaseHealthcareProfessionalFilterBuilder<NonSortableHealthcareProfessionalFilter> {
