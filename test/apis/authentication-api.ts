...
describe('Authentication API', () => {
  ...
  it('HCP should be capable of signing up using email with friendlyCaptchaData', async () => {
    // When
    const recaptcha =
      'bc8b2c9417f070353431f9c85ff207ee.ZA7/m/FMRKjM6zH5AQwtjQAAAAAAAAAAw8tcC8fO8n8=..AgAA'
