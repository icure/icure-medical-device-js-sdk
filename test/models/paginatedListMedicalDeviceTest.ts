...
describe('PaginatedListMedicalDevice model test', () => {
  it('Marshalling/Unmarshalling of PaginatedListMedicalDevice model - Success', () => {
    ...
    assert.deepEqual(unmarshalledPaginatedListMedicalDevice, paginatedListMedicalDevice)
    assert.deepEqual(new PaginatedListMedicalDevice(paginatedListMedicalDevice), paginatedListMedicalDevice)
  });
});
